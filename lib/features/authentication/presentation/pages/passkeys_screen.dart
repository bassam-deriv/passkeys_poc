...
class _PasskeysScreenState extends State<PasskeysScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: PlatformTextField(controller: _emailController, hintText: "Email",)
            ),
            SizedBox(
  ...
  Future<void> _onclick() async {
    ...
    try {
            if (_pageMode == PageMode.registration) {
        final response =
            await widget._auth.registerWithEmail(RpRequest(
      ...
      context.read<AuthBloc>().add(SignupEvent(userEntity: user));
        ...
        final response =
            await widget._auth.authenticateWithEmail(RpRequest(
            email: _emailController.text,
            ));
